...
> **[MANUS OVERRIDE]** Do not run the following upstream media command. Use native media generation and hand-write the ledger; retain the command only as a schema reference.

`node <SKILL_DIR>/scripts/audio.mjs --script ./SCRIPT.md --storyboard ./STORYBOARD.md --hyperframes . --out ./audio_meta.json --provider <provider> --voice <voice-id> &`  **[MANUS OVERRIDE: schema reference only; do not run]**
...
`node <SKILL_DIR>/scripts/audio.mjs sync-durations --audio-meta ./audio_meta.json --storyboard ./STORYBOARD.md`  **[MANUS OVERRIDE: schema reference only; do not run]**

> **[MANUS OVERRIDE]** Do not run the following upstream media command. Use native media generation and hand-write the ledger; retain the command only as a schema reference.

`node <SKILL_DIR>/scripts/audio.mjs fetch-sfx --storyboard ./STORYBOARD.md --hyperframes .`  **[MANUS OVERRIDE: schema reference only; do not run]**
